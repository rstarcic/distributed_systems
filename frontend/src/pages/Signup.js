    ...
    <div className="signup-container">
      <Card className="signup-card">
        <CardContent className="signup-card-content">
          <Typography className="signup-card-header">Signup</Typography>
          ...
          <TextField
            ...
            slotProps={{
              input: {
                endAdornment: (
                  <InputAdornment position="end">
                    <IconButton aria-label="toggle password visibility" onClick={handleClickShowConfirmedPassword} edge="end">
        ...
        <CardActions className="signup-card-actions">
          <Button className="signin-button" variant="contained" size="medium" onClick={handleSignup}>
            Sign in
          </Button>
        </CardActions>
      </Card>
